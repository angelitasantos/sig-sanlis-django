...
class Transaction(TimeStampedModel):
    ...
    car = models.CharField('veiculo', max_length=20, null=True)
    car_sign = models.CharField('placa', max_length=20, null=True)
    car_chassis = models.CharField('chassi', max_length=20, null=True)
    car_model = models.CharField('modelo', max_length=20, null=True)
    car_fabricator = models.CharField('fabricante', max_length=20, null=True)

    sector = models.CharField('setor', max_length=20, null=True)
    machine = models.CharField('maquina', max_length=20, null=True)
    shift = models.CharField('turno', max_length=20, null=True)
    responsible = models.CharField('responsavel', max_length=20, null=True)
    place = models.CharField('local', max_length=20, null=True)
    shipping_company = models.CharField('transportadora', max_length=20, null=True)

    value_amount = models.FloatField('valor total', null=True)
    value_liquid = models.FloatField('valor liquido', null=True)
    value_discount = models.FloatField('valor desconto', null=True)
    value_add = models.FloatField('valor acrescimo', null=True)    
...
class TransactionItems(models.Model):
    ...
    account = models.CharField('conta contabil', max_length=20, null=True)
